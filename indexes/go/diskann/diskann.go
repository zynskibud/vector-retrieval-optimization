// Package diskann is the DiskANN index (CONTRACT.md section 6.7).
//
...
var BuildDefaults = map[string]any{"r": 64, "l_build": 100, "alpha": 1.2, "pq_m": 48, "metric": "ip"}

// SearchDefaults lists every search parameter with its default.
var SearchDefaults = map[string]any{"l": 100, "beam": 4, "rerank": 100, "io": "mmap"}
